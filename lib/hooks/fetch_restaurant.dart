...
import 'package:sopefoodrestaurantes/models/hook_models/restaurant_data.dart';
import 'package:sopefoodrestaurantes/models/restaurant_data.dart';
...
FetchRestaurantData fetchRestaurant(
  ...
  Future<void> fetchData() async {
    ...
    try {
      Uri url =
          Uri.parse('${Environment.appBaseUrl}/api/restaurant/statistics/$id');
