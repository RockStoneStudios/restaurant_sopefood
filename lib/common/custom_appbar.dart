...
import 'package:sopefoodrestaurantes/controllers/updates_controllers/picked_controller.dart';
import 'package:sopefoodrestaurantes/controllers/updates_controllers/ready_for_pick_up_controller.dart';
import 'package:sopefoodrestaurantes/views/profile/profile_page.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ReusableText(
                            ...
                            style: appStyle(19, kSecondary, FontWeight.w700)),
                        SizedBox(
                          width: width * 0.65,
                          child: ReusableText(
                              text: title != null
