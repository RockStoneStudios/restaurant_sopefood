...
import 'package:sopefoodrestaurantes/controllers/login_response.dart';
import 'package:sopefoodrestaurantes/controllers/notifications_controller.dart';
import 'package:sopefoodrestaurantes/controllers/restaurant_controller.dart';
import 'package:sopefoodrestaurantes/main.dart';
...
import 'package:sopefoodrestaurantes/views/auth/restaurant_registration.dart';
import 'package:sopefoodrestaurantes/views/auth/login_page.dart';
import 'package:sopefoodrestaurantes/views/auth/verification_page.dart';
import 'package:sopefoodrestaurantes/views/auth/waiting_page.dart';
  ...
  void loginFunc(String model) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Get.snackbar("Inicio sesión correctamente ",
            "Disfruta de tu increíble experiencia",
